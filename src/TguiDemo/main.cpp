...
int main()
{
	...
	try
	{
		tgui::Theme theme {"./data/TguiDemo/widgets/Black.txt"};

		gui.add( tgui::Picture::create( "./data/TguiDemo/RedBackground.jpg" ) );
		...
		sf::Texture texture;
		sf::Sprite  sprite;
		texture.loadFromFile( "./data/TguiDemo/ThinkLinux.jpg" );
